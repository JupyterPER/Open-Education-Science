...
The notebooks folder ([`UEQ`](UEQ), [`CaseStudies`](CaseStudies), [`Rnotebooks`](PYnotebooks)) contain R based Jupyter notebooks which are detailed records of our open data analysis with explaining narratives ilustrating explored concepts and methods. 
